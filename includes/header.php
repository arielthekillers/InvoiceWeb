...
<head>
  ...
  <!-- jQuery (Required for existing scripts, ajax, and datetime picker) -->
  ...
  <script src="<?php echo BASE_URL; ?>js/bootstrap.datetime.js"></script>
      ...
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu shadow-sm border-0" aria-labelledby="invoiceDropdown">
            ...
            <li><a class="dropdown-item download-csv" href="#"><i class="bi bi-download me-1"></i> Download CSV</a></li>
          </ul>
        </li>
        <li class="nav-item">
      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" aria-labelledby="dropdownUser1">
            ...
            <li><a class="dropdown-item pt-2 text-danger" href="<?php echo BASE_URL; ?>logout.php"><i class="bi bi-box-arrow-right me-1"></i> Sign out</a></li>
          </ul>
        </li>
      </ul>
    </div>
